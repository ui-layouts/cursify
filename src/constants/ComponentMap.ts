...
import InkCursorExample from "@/components/examples/InkCursorExample";
...
export const ComponentMapping = {
  ...
  "trail-cursor": TrailCursorExample,
  "blob-cursor": BlobCursorExample,
  "click-cursor": ClickCursorExample,
  ...
  "fairy-dust-cursor": FairyDustCursorExample,
  "textflag-cursor": TExtFlagCursorExample,
  "snowflake-cursor": SnowflakeCursorExample,
