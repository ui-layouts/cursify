...
import TrailCursor from '../cursor/common/TrailCursor';

const TrailUpdateCursorExample = () => {
                    ...
                    <CardContent>
                         <div className="space-y-4">
                              <div>
                                   ...
                                   <AdvancedCodeBlock
                                        code={codeToDisplay}
                                        fileName="./TrailUpdateCursorExample.tsx"
                                        lang="typescript"
                                   />
                              </div>
                         </div>
...
export default TrailUpdateCursorExample;