...
import SwirlCursor from '../cursor/common/SwirlCursor';

const SwirlCursorExample = () => {
     const codeToDisplay = ``;
     ...
     return (
          <div className="container mx-auto px-4 py-8 space-y-6">
               ...
               <Card className='border-none shadow-none'>
                    <CardHeader>
                         <CardTitle className="text-2xl">Swirl Cursor Component</CardTitle>
                         <CardDescription>
               ...
               <Card className='border-none shadow-none'>
                    <CardHeader>
                         ...
                         <CardDescription>
                              Detailed code breakdown of the Swirl Cursor component
                         </CardDescription>
                    </CardHeader>
                    <CardContent>
                         <div className="space-y-4">
                              <div>
                                   <h4 className="text-lg font-semibold mb-2">
                                        Swirl Cursor Component
                                        <Badge variant="secondary" className="ml-2">TSX</Badge>
                                   </h4>
                                   <AdvancedCodeBlock
                                        code={codeToDisplay}
                                        fileName="./SwirlCursorExample.tsx"
                                        lang="typescript"
                                   />
                              </div>
...
export default SwirlCursorExample;