     ...
     return (
          ...
          >
               ...
               <ComponentCard
                    ...
                    description="An interactive React component that leverages the canvas API to dynamically visualize cursor movement with creative effects."
               >
               ...
               >
                    <div className="space-y-4">
                         ...
                         <CodeExample
                              title="Create useCanvasCursor.ts hook"
                              code={codeToDisplayHook}
                              fileName="./useCanvasCursor.ts"
                              badgeText="ts"
                         />
                         ...
                         <CodeExample
                              title="Create CanvasCursor.tsx file."
                              code={codeToDisplay}
                              fileName="./CanvasCursor.tsx"
                              badgeText="tsx"
                         />
                    </div>
               </ComponentCard>
