'use client';
import AnimatedText from '../common/cursor-follow-text';
...
function Footer() {
     return (
          <>
               ...
               >
                    <div className='gap-10 sm:flex justify-between p-5 2xl:py-10 py-5 dark:bg-[#0c0c0c]   bg-blue-500 rounded-sm rounded-b-none text-white'>
                         <div className='w-fit flex-col  flex  justify-center'>
                              <div className='2xl:w-24 2xl:h-24 w-20 h-20 ml-3 bg-white  rounded-sm before:absolute relative before:w-full before:h-full before:bg-white/50  before:rounded-md before:-top-3 before:-left-3'>

                              </div>
                              <article className='py-2  2xl:w-80 w-64  space-y-1'>
                                   <h1 className='newFont text-3xl font-bold'>Cursify</h1>
                         ...
                         <div className='sm:block flex sm:mt-0 mt-4  gap-2 sm:w-auto w-full sm:space-y-2 relative z-[1]'>
                              ...
                              <a
                                   href='https://www.linkedin.com/in/durgesh-bachhav-914bb8337/'
                                   target='_blank'
                                   className='bg-gray-50 sm:w-auto w-full  grid place-content-center  2xl:h-40 h-32 2xl:p-10 p-5 rounded-lg'
                              >
                                   <svg
