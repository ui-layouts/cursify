    ...
    >
      ...
      {HoverFocusSpotlight && (
        <div
          ...
          style={{
            background: `radial-gradient(circle at ${mousePosition.x}px ${mousePosition.y}px, #0d4eff76 0%,transparent 20%,transparent) fixed `,
          }}
        ></div>
      )}
      {ProximitySpotlight && (
        <div
          ...
          style={{
            background: `radial-gradient(circle at ${mousePosition.x}px ${mousePosition.y}px, #0d4eff 0%,transparent 20%,transparent) fixed`,
          }}
        ></div>
      )}
      {children}
